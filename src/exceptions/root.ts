...
export enum ErrorCode {
  ...
  CODE_EXPIRED = 2003,
  USER_DELETED = 2004,
  NOTIFICATION_NOT_FOUND = 2005,
  ANNOUNCEMENT_NOT_FOUND = 2006,
  PARENT_COMMENT_NOT_FOUND = 2007,
  COMMENT_NOT_FOUND = 2008,
  BANNER_NOT_FOUND = 2009,

  UNAUTHORIZED = 3001,
  FORBIDDEN = 3002,

  VALIDATION_ERROR = 4001,
  UNPROCESABLE_ENTITY = 4002,
  FILE_REQUIRED = 4003,
